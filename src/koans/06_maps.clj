...
(meditations
  ...
  "Maps can be used as functions to do lookups" ;;splendid! :D
  (= 1 ({:a 1 :b 2} :a))
  ...
  "Specify how to handle entries with same keys when merging" ;; :O
  (= {:a 1 :b 9 :c 3} (merge-with * {:a 1 :b 3} {:b 3 :c 3}))
